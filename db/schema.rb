...
ActiveRecord::Schema.define(version: 20170329021208) do

  create_table "private_messages", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.text     "content",    limit: 65535
    t.integer  "user_me_id"
    t.integer  "user_he_id"
    t.datetime "created_at",               null: false
    t.datetime "updated_at",               null: false
    t.index ["user_he_id"], name: "index_private_messages_on_user_he_id", using: :btree
    t.index ["user_me_id"], name: "index_private_messages_on_user_me_id", using: :btree
  end
